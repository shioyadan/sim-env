...
def main():
    ...
    # Parse arguments 
    parser = argparse.ArgumentParser(description='SPECCPU2016 command converter for Onikiri2.')
    parser.add_argument('INSTALL_DIR', type=str, help='Specify a SEPCCPU2016 directory.')
    ...
    parser.add_argument('MARKER', type=str, 
        help='Specify an architectural name maker. This script search files from benchspec/CPU2016/xxx/run/* including this mark')
